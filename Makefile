...
chessviz: build/main.o build/searchsym.o build/board_print.o build/tokenlen.o
	gcc -Wall -Werror -o bin/chessviz.run build/main.o build/searchsym.o build/board_print.o build/tokenlen.o -MP -MMD

build/main.o: src/main.c
	gcc -Wall -Werror -o build/main.o -c src/main.c -MP -MMD
...
build/board_print.o: src/board_print.c
	gcc -Wall -Werror -o build/board_print.o -c src/board_print.c -MP -MMD
