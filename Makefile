...
build/searchsym.o: src/searchsym.c
	gcc -Wall -Werror -o build/searchsym.o -c src/searchsym.c -MP -MMD -MT 'src/searchsym.h'
...
build/tokenlen.o: src/tokenlen.c
	gcc -Wall -Werror -o build/tokenlen.o -c src/tokenlen.c -MP -MMD -MT 'src/tokenlen.h'
